...
class NativeAD_Admin extends NativeAD  {
	...
	public static function admin_native_menu() {
		...
		$page = add_menu_page( 'Setup NativeAD', 'NativeAD', 'manage_options', 'nativead', array( 'NativeAD_Admin', 'admin_native_form' ),  plugin_dir_url( __FILE__ ) . 'assets/icons/20x20blanco.png' );
